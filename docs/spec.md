...
| ヘルス | Health Connect の歩数・運動・心拍・睡眠・体重・体脂肪率・栄養情報と各種推移を確認する |
...
- Health Connect から歩数、運動セッション、心拍、睡眠、体重、体脂肪率、栄養情報を参照する。
...
- アプリ内で完了・保存したワークアウトのみ、ADR-0131に従って Health Connect へ一方向に書き出す。
