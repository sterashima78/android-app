...
この文書は Video feature の current architecture を示す。設計判断の履歴は [ADR-0237](../adr/0237-video-library-and-web-extraction.md) と [ADR-0239](../adr/0239-shared-smb-connection-profiles-and-feature-locations.md) を参照する。
