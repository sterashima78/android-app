# ADR-0127: Calendar を複数 Context と Android Calendar Provider の read model として扱う

- Status: Accepted
- Date: 2026-08-19
- Refines: ADR-0103, ADR-0106, ADR-0116, ADR-0120, ADR-0122, ADR-0126
...
ADR-0126 の capability segregation に従い、`:feature:calendar:data` は full Repository ではなく次の read capability に依存する。
