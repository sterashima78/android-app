# ADR-0107: Root feature ViewModel の wiring を Route composition が所有する
...
- `MainActivity` に feature ViewModel property が再導入されないよう architecture verification の追加を検討する。
