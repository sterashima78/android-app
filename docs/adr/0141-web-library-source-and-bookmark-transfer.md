# ADR-0141: Web URL を Library source として扱い Bookmark と安全に移動する

- Status: Accepted
- Date: 2026-08-22
- Refines: [ADR-0013](0013-library-sources-and-google-books-sync.md), [ADR-0106](0106-domain-context-aggregate-and-persistence-ownership.md), [ADR-0117](0117-cross-context-persistence-boundary-phase1.md), [ADR-0125](0125-application-service-and-capability-segregation.md)
...
Bookmark と Web Library の相互移動は `BookmarkLibraryTransferService` が調停する。各 Context の所有 API だけを利用し、foreign table へ直接アクセスしない。
