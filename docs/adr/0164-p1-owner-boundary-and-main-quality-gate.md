...
> Update (2026-08-27): Decision 3 と、それに対応する main quality gate の consequence / verification は [ADR-0197](0197-split-pr-checks-and-main-apk-build.md) で supersede された。Decision 1 と Decision 2 は引き続き有効。
