...
> Current architecture: ADR-0188 により、`IntegratedRoute`、projection、dispatch、item action を含む横断 presentation 全体は `:feature:integrated:ui` が所有する。`:app` に残すのは dependency wiring、app-shell navigation、Android platform callback のみとする。
...
- ADR-0188 が Integrated の current presentation ownership を更新する
