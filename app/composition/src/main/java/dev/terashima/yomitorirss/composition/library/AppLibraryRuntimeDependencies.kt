...
import dev.terashima.yomitorirss.feature.library.data.DefaultSmbConnectionProfileRepository
...
internal class AppLibraryRuntimeDependencies(
  ...
  val runtime: LibraryRuntimeDependencies by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
    ...
    val smbConnectionProfileRepository = DefaultSmbConnectionProfileRepository(application, database)
