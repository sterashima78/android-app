...
android { namespace = "dev.terashima.yomitorirss.composition"; compileSdk = 36; defaultConfig { minSdk = 34 }; compileOptions { sourceCompatibility = JavaVersion.VERSION_17; targetCompatibility = JavaVersion.VERSION_17 } }
dependencies {
  implementation(project(":core:background")); implementation(project(":core:database")); implementation(project(":core:ai-inference")); implementation(project(":core:ai-cloud-openai")); implementation(project(":core:ai-runtime")); implementation(project(":core:network"))
  ...
  implementation(project(":feature:knowledge:domain")); implementation(project(":feature:knowledge:data")); implementation(project(":feature:knowledge:ui"))
  ...
  implementation(project(":feature:summary:domain")); implementation(project(":feature:summary:data")); implementation(project(":feature:summary:ui"))
  ...
  implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:2.10.0"); implementation("androidx.work:work-runtime-ktx:2.11.2"); implementation(libs.kotlinx.coroutines.android)
}
