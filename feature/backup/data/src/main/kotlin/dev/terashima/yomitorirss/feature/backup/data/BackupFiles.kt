...
internal const val AUTO_BACKUP_SUFFIX = "-v2.zip"
internal const val AUTO_BACKUP_RETENTION = 10
private const val LEGACY_AUTO_BACKUP_SUFFIX = "-v1.json"
...
private fun isManagedAutoBackup(name: String): Boolean =
  name.startsWith(AUTO_BACKUP_PREFIX) &&
    (name.endsWith(AUTO_BACKUP_SUFFIX) || name.endsWith(LEGACY_AUTO_BACKUP_SUFFIX))
