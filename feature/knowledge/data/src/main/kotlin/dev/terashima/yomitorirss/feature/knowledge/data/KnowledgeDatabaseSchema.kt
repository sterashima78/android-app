...
val knowledgeDatabaseSchema = DatabaseSchemaContribution(
  ...
  createSchema = { db ->
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS knowledge_page_sources(page_id TEXT NOT NULL REFERENCES knowledge_pages(id) ON DELETE CASCADE,article_id TEXT NOT NULL,title TEXT NOT NULL,url TEXT NOT NULL,source_title TEXT NOT NULL,saved_at TEXT NOT NULL,PRIMARY KEY(page_id,article_id))")
