...
val summaryDatabaseSchema = DatabaseSchemaContribution(
  ...
  createSchema = { db ->
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS summary_article_content(article_id TEXT PRIMARY KEY NOT NULL REFERENCES summary_tasks(article_id) ON DELETE CASCADE,content TEXT NOT NULL,fetched_at TEXT NOT NULL)")
  },
)
