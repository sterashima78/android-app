...
class LiteRtLmModelSectionsTest {
  ...
  private fun buildFlatBufferHeader(sectionType: Int, begin: Long, end: Long): ByteArray {
    ...
    buffer.putShort(6, 8)
    buffer.putShort(8, 0)
    buffer.putShort(10, 4)
    buffer.putInt(12, 8)
    buffer.putInt(16, 12)

    buffer.putShort(20, 6)
    buffer.putShort(22, 8)
    buffer.putShort(24, 4)
    buffer.putInt(28, 8)
    buffer.putInt(32, 4)
    ...
    buffer.putShort(44, 12)
    buffer.putShort(46, 25)
    buffer.putShort(48, 0)
    buffer.putShort(50, 8)
    buffer.putShort(52, 16)
    buffer.putShort(54, 24)
    buffer.putInt(56, 12)
